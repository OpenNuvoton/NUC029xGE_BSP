 ...
 * @file     sdcard.c
 * @version  V1.00
 * @brief    NUC029xGE series SD Card source file
 *
 * @note
...
uint32_t MMC_Command_Exec(uint8_t nCmd, uint32_t nArg, uint8_t *pchar, uint32_t *response)
{
    ...
    PC4 = 0;//SPI_SET_SS_LOW(g_pSPI);// CS = 0
...
/*@}*/ /* end of group NUC029xGE_SDCARD_Driver */
