 ...
 * @file     sdcard.h
 * @version  V1.00
 * @brief    NUC029xGE series SD Card driver header file
 *
 * @note
...
/** @addtogroup NUC029xGE_Library NUC029xGE Library
  @{
*/

/** @addtogroup NUC029xGE_SDCARD SDCARD Library
  @{
*/

/** @addtogroup NUC029xGE_SDCARD_EXPORTED_CONSTANTS SDCARD Library Exported Constants
  @{
*/
...
#define BACK_FROM_ERROR { SingleWrite(0xFF); PC4 = 1;  return FALSE;} /*!< macro for SPI write */
...
/*@}*/ /* end of group NUC029xGE_SDCARD_EXPORTED_CONSTANTS */

/** @addtogroup NUC029xGE_SDCARD_EXPORTED_STRUCTS SDCARD Library Exported Structs
  @{
*/
...
/*@}*/ /* end of group NUC029xGE_SDCARD_EXPORTED_STRUCTS */

/** @addtogroup NUC029xGE_SDCARD_EXPORTED_FUNCTIONS SDCARD Library Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC029xGE_SDCARD_EXPORTED_FUNCTIONS */


/*@}*/ /* end of group NUC029xGE_SDCARD */

/*@}*/ /* end of group NUC029xGE_Library */
