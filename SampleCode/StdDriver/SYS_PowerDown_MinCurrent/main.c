 ...
 * @return      None
 *
 * @details     The PortA/PortB default IRQ, declared in startup_NUC029xGE.s.
 */
void GPAB_IRQHandler(void)
{
...
void SYS_Init(void)
{
    ...
    /* Set multi-function pins for UART0 RXD(PA.3) and TXD(PA.2) */
...
int32_t main(void)
{
    ...
    /*
        ...
        On NuMaker-NUC029SGE V1.0 board, remove components, e.g. Nu-Link2-Me and R7.
        Remove R16 and then user can measure target chip power consumption by AMMETER connector.

        On NuTiny-SDK-NUC029KGE V1.0 board, remove components, e.g. Nu-Link2-Me, R6 and R7.
    */
